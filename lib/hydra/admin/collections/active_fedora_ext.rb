module Hydra::Admin::Collections
  module ActiveFedoraExt
    ...
    def belongs_to_admin_collection(args={})
      belongs_to args.fetch(:name, :collection), class_name: args.fetch(:class_name, 'Hydra::Admin::Collection'), predicate: args.fetch(:predicate, ::RDF::DC.isMemberOfCollection)
    end
  end
end
