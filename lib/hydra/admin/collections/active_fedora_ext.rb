module Hydra::Admin::Collections
  module ActiveFedoraExt
    ...
    def belongs_to_admin_collection(args={})
      belongs_to args.fetch(:name, :collection), class_name: args.fetch(:class_name, 'Hydra::Admin::Collection'), local_authorities: args.fetch(:local_authorities, :is_member_of_collection)
    end
  end
end
